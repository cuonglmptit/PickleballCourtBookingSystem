package com.maxholmes.androidapp.screen.courtowner.bookschedule.adapter
...
class CustomBookingCourtOwnerAdapter : RecyclerView.Adapter<CustomBookingCourtOwnerAdapter.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        fun bindViewData(booking: CustomBookingResponse) {
            ...
            val dateUse = "Ngày dùng sân: ${booking.courtTimeSlots?.get(0)?.date!!.toCustomDateFormat()}"
            ...
            binding.tvPhone.text = booking.customerPhoneNumber ?: "Không có số điện thoại"
        }
