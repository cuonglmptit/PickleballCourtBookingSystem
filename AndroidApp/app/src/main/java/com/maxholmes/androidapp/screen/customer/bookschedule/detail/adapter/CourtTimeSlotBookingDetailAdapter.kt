...
class CourtTimeSlotBookingDetailAdapter(private val timeSlots: List<CourtTimeSlot>) :
    RecyclerView.Adapter<CourtTimeSlotBookingDetailAdapter.CourtTimeSlotViewHolder>() {
